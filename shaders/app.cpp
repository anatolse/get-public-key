...
{
	get_public_key::InitialParams params;

	Env::GenerateKernel(nullptr, get_public_key::InitialParams::METHOD, &params, sizeof(params), nullptr, 0, nullptr, 0, "Create get_public_key contract", 0);
}

void On_action_destroy_contract(const ContractID& cid)
{
	Env::GenerateKernel(&cid, 1, nullptr, 0, nullptr, 0, nullptr, 0, "Destroy get_public_key contract", 0);
}

void On_action_view_contracts(const ContractID& unused)
{
	EnumAndDumpContracts(get_public_key::s_SID);
}
